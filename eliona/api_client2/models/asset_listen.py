...
class AssetListen(BaseModel):
    ...
    children_info: Optional[List[Asset]] = Field(default=None, description="List of children for this asset.", alias="childrenInfo")
    ...
    __properties: ClassVar[List[str]] = ["resourceId", "id", "deviceIds", "projectId", "globalAssetIdentifier", "name", "assetType", "latitude", "longitude", "isTracker", "description", "parentFunctionalAssetId", "functionalAssetIdPath", "parentLocationalAssetId", "locationalAssetIdPath", "tags", "childrenInfo", "attachments", "statusCode"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "childrenInfo": [Asset.from_dict(_item) for _item in obj.get("childrenInfo")] if obj.get("childrenInfo") is not None else None,

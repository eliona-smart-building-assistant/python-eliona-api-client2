...
class AssetTypeAttribute(BaseModel):
    ...
    category_name: Optional[StrictStr] = Field(default=None, description="a reference to a asset type category", alias="categoryName")
    __properties: ClassVar[List[str]] = ["assetTypeName", "name", "subtype", "type", "enable", "translation", "unit", "precision", "min", "max", "aggregationMode", "aggregationRasters", "viewer", "ar", "sequence", "virtual", "formula", "scale", "zero", "map", "sourcePath", "isDigital", "categoryName"]

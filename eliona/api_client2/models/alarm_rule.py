...
class AlarmRule(BaseModel):
    ...
    check_type: Optional[StrictStr] = Field(default='limits', description="Check type", alias="checkType")
    ...
    def check_type_validate_enum(cls, value):
        ...
        if value not in ('limits', 'validity', 'custom'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "checkType": obj.get("checkType") if obj.get("checkType") is not None else 'limits',

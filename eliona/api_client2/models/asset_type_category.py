...
class AssetTypeCategory(BaseModel):
    """
    A category for asset types
    """ # noqa: E501
    name: StrictStr = Field(description="The unique name for this asset type category")
    translation: Optional[Translation] = None
    properties: Optional[List[AssetTypeCategoryProperty]] = Field(default=None, description="List of asset type category properties")
    __properties: ClassVar[List[str]] = ["name", "translation", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [AssetTypeCategoryProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj

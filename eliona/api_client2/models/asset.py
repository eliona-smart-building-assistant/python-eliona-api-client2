...
class Asset(BaseModel):
    ...
    An asset
    """ # noqa: E501
    resource_id: Optional[UUID] = Field(default=None, description="A custom identifier for the resource, which can be utilized to identify it for various operations such as updates, deletions, and other related tasks. If this identifier is not provided, the application will generate a new value for it automatically", alias="resourceId")

...
*AssetTypesApi* | [**delete_asset_type_category_by_name**](docs/AssetTypesApi.md#delete_asset_type_category_by_name) | **DELETE** /asset-type-categories/{asset-type-category-name} | Delete an asset type category
...
*AssetTypesApi* | [**get_asset_type_categories**](docs/AssetTypesApi.md#get_asset_type_categories) | **GET** /asset-type-categories | List of asset type categories
...
*AssetTypesApi* | [**put_asset_type_category**](docs/AssetTypesApi.md#put_asset_type_category) | **PUT** /asset-type-categories | Create or update an asset type categories
...
*TicketsApi* | [**delete_ticket_by_id**](docs/TicketsApi.md#delete_ticket_by_id) | **DELETE** /tickets/{ticket-id} | Delete a ticket
*TicketsApi* | [**get_ticket_by_id**](docs/TicketsApi.md#get_ticket_by_id) | **GET** /tickets/{ticket-id} | Information about a ticket
*TicketsApi* | [**get_tickets**](docs/TicketsApi.md#get_tickets) | **GET** /tickets | Information about tickets
*TicketsApi* | [**post_ticket**](docs/TicketsApi.md#post_ticket) | **POST** /tickets | Create a ticket
*TicketsApi* | [**put_ticket_by_id**](docs/TicketsApi.md#put_ticket_by_id) | **PUT** /tickets/{ticket-id} | Update a ticket
